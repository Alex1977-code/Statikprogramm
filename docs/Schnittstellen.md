...
|---|---|---|---|
| `.json` | Statik3D | – | vollständiges Modell (Format 1 bis 4; Format 3 brachte Linien und Gelenke, Format 4 die **Anschlüsse**, die **Verformungsgrenzen**, die **Beulfelder** (mit Steifen) und die **Lasteinleitungsstellen**. Ältere Dateien werden gelesen) |

...
|---|---|---|---|
| `.json` | Statik3D | – | vollständiges Modell (Format 1 bis 4; Format 3 brachte Linien und Gelenke, Format 4 die **Anschlüsse**, die **Verformungsgrenzen** und die **Beulfelder**. Ältere Dateien werden gelesen) |
